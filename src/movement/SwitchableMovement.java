...
public interface SwitchableMovement {
  ...
  /**
   * Checks if the movement model is finished doing its task and it's time to switch to the next
   * movement model. The method should be called between getPath() calls.
   *
