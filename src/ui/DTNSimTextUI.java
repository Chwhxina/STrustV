...
public class DTNSimTextUI extends DTNSimUI {
  ...
  /**
   * Updates user interface if the long enough (real)time (update interval) has passed from the
   * previous update.
   *
   * @param forced If true, the update is done even if the next update interval hasn't been reached.
   */
