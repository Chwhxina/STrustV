...
public class RoutingInfo {
  ...
  /**
   * Creates a routing info based on any object. Object's toString() method's output is used as the
   * info text.
   *
   ...
   *
   * @return The children of this info or an empty list if this info doesn't have any children.
   */
