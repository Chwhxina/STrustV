 ...
 * @time2: 2021/06/09
 */
public class RouterPreConnInterface extends NetworkInterface {
   ...
   * @time: 2021/05/10
   */
  public RouterPreConnInterface(Settings s) {
    super(s);
  }
   ...
   * @time: 2021/05/10
   */
  public RouterPreConnInterface(RouterPreConnInterface rpci) {
    super(rpci);
  }
  ...
  public NetworkInterface replicate() {
    return new RouterPreConnInterface(this);
  }
  ...
  public void connect(NetworkInterface anotherInterface) {
    if (isScanning()
      ...
      List<MapNode> mn = RouterPreConnEngine.getRouterNodes();
      ...
      RouterPreConnEngine.setMrouterNodes(mn);
    }
  }
  ...
  /**
   * Updates the state of current connections (ie,. A malicious route should be disconnected or for
   * some other reason the route's link relationship needs to be changed )
   *
   * 
   * 
   * @time: 2021/05/22
  ...
  public String toString() {
    return "RouterPreConnInterface " + super.toString();
  }
}
