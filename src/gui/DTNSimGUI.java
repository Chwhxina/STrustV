...
public class DTNSimGUI extends DTNSimUI {
  ...
  private void initGUI() {
    ...
    this.main =
        new MainWindow(
            this.scen.getName(), world, field, guiControls, infoPanel, eventLogPanel, this);
  ...
  /**
   * Processes assertion errors by showing a warning dialog to the user and pausing the simulation
   * (if it's running)
   *
  ...
  private void processAssertionError(AssertionError e) {
    ...
    if (selection == 0) {
      ...
      JOptionPane.showMessageDialog(
          getParentFrame(), txt, "stack trace", JOptionPane.INFORMATION_MESSAGE);
    }
  }
