...
public class EventLogControlPanel extends JPanel implements ActionListener {
  ...
  public EventLogControlPanel() {
    ...
    setLayout(layout);
    this.setBorder(BorderFactory.createTitledBorder(getBorder(), TITLE_TEXT));
  ...
  /**
   * Adds a new heading in the control panel. Subsequent addControl controls will be under this
   * heading
   *
