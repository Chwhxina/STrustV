 ...
 *
 * <p>[Simulation time] [average buffer occupancy % [0..100] ] [variance]
 *
 * <p>The occupancy is calculated as an instantaneous snapshot every nth second as defined by the
 * <code>occupancyInterval</code> setting, not as an average over time.
 *
 * @author teemuk
 */
...
public class BufferOccupancyReport extends Report implements UpdateListener {
  ...
  /**
   * Record occupancy every nth second -setting id ({@value}). Defines the interval how often
   * (seconds) a new snapshot of buffer occupancy is taken
   */
