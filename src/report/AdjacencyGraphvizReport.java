...
/**
 * Generates Graphviz compatible graph from connections. Connections that happen during the warm up
 * period are ignored.
 */
public class AdjacencyGraphvizReport extends Report implements ConnectionListener {
  ...
  /** Private class stores information of the connected hosts and nrof times they have connected. */
