 ...
 * @author teemuk
 */
public abstract class SamplingReport extends Report implements UpdateListener {
  ...
  protected SamplingReport() {
    ...
    this.interval = settings.getDouble(SAMPLE_INTERVAL_SETTING, DEFAULT_SAMPLE_INTERVAL);
    if (this.interval <= 0) {
      throw new SettingsError(
          "Setting '"
              + SAMPLE_INTERVAL_SETTING
