...
/**
 * Report information about all delivered messages. Messages created during the warm up period are
 * ignored. For output syntax, see {@link #HEADER}.
 */
public class DeliveredMessagesReport extends Report implements MessageListener {
  public static String HEADER =
      "# time  ID  size  hopcount  deliveryTime  "
