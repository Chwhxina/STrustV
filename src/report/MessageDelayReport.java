...
/**
 * Reports delivered messages' delays (one line per delivered message) and cumulative delivery
 * probability sorted by message delays. Ignores the messages that were created during the warm up
 * period.
 */
